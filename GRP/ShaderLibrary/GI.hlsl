#ifndef GRP_GI_INCLUDED
#define GRP_GI_INCLUDED
#include "Packages/com.unity.render-pipelines.core@10.5.1/ShaderLibrary/EntityLighting.hlsl"
...
{
    #ifdef LIGHTMAP_ON
    return SampleSingleLightmap(TEXTURE2D_ARGS(unity_Lightmap, samplerunity_Lightmap),uv,
